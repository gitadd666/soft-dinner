...
if (isset($_POST['correo']) && isset($_POST['contrasena'])) {
    ...
    if ($usuario) 
    {
        ...
        {
            // Guardar datos relevantes en la sesión para su uso en otras páginas
            $_SESSION['user_correo'] = $correo;
            $_SESSION['user_nombre'] = isset($usuario['nombre']) ? $usuario['nombre'] : '';
...
<a href="RestablecerContraseña/1restablezcaContraseña.php" style="">¿Olvidaste la Contraseña?</a> <br>
